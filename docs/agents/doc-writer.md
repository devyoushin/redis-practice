...
- 기존 문서 품질 개선 및 섹션 보완
- `docs/rules/doc-writing.md` 스타일 가이드 엄격 준수
...
- `docs/rules/doc-writing.md` — 문서 구조 및 언어 규칙
- `docs/rules/redis-conventions.md` — CLI/설정 코드 규칙
- `docs/rules/monitoring.md` — 모니터링 섹션 형식
